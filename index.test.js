...
describe('[Exercise 3] findLargestInteger', () => {
   test('[5] returns the largest number in an array of objects { integer: 2 }', () => {
    ...
    const input3 = [{ integer: 4 }, { integer: 3 }, { integer: 5}]
    const acutal = utils.findLargestInteger(input)
    const acutal2 = utils.findLargestInteger(input2)
    const acutal3 = utils.findLargestInteger(input3)
    expect(acutal).toBe(3)
    expect(acutal2).toBe(4)
    expect(acutal3).toBe(5)
   })
})
...
describe('[Exercise 6] Car', () => {
  ...
  test('[15] driving the car returns the updated odometer', () => {
    ...
    expect(focus.drive(200)).toBe(400)
